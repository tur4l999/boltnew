...
function StatusBar15Pro({
    ...
    const update = () => {
      ...
      setTime(
        now.toLocaleTimeString("en-US", {
          hour: "numeric",
          minute: "2-digit",
          hour12: true, // şəkilə uyğun 9:41 formatı
  ...
  return (
    <div className={`relative w-full h-[44px] ${bg} flex items-center justify-between px-4 text-[15px]`}>
