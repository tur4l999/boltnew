...
import { getOnboardingColors, onboardingTypography, onboardingSpacing } from './theme';
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex items-center justify-between px-5 pt-16 pb-4">
        ...
        {!isLast && (
          <button
            onClick={handleSkip}
            disabled={isNavigating}
            className="px-4 py-2 rounded-lg transition-all duration-200 hover:bg-black/5 active:scale-95"
            style={{
              minHeight: '44px',
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 pb-12">
        {/* Illustration */}
        <div
          className="w-full max-w-sm mb-12 transition-all duration-500"
          style={{
      ...
      <div className="pb-12 px-6 space-y-8">
        ...
        <div className="w-full max-w-md mx-auto">
          <button
            onClick={handleNext}
            disabled={isNavigating}
            className="w-full rounded-2xl transition-all duration-200 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
            style={{
